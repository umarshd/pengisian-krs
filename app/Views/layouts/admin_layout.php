...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav " id="sidebar-nav">
        ...
        <ul id="components-fakultas" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/fakultas') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>List Fakultas</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('/admin/fakultas/tambah') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>Tambah Fakultas</span>
            </a>
          </li>
        </ul>
      </li>
        ...
        <ul id="components-jurusan" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/jurusan') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>List Jurusan</span>
            </a>
          </li>
          <li>
        ...
        <ul id="components-semester" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/semester') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>List Semester</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('/admin/semester/tambah') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>Tambah Semester</span>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item nav-side">
        <a class="nav-link collapsed" data-bs-target="#components-matakuliah" data-bs-toggle="collapse" href="#">
          <i class="bi bi-calendar-check"></i>
          <span>Data Mata Kuliah</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-matakuliah" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('/admin/matakuliah') ?>" class="a ">
              <i class=" bi bi-circle"></i><span>List Mata Kuliah</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('/admin/matakuliah/tambah') ?>" class="a ">
